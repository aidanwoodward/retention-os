...
> **Historical runbook — archived.** Canonical sprint operating system: [`OPS_01.md`](../../agent/OPS_01.md). This file is preserved as pre-restart evidence only.

## Purpose

RetentionOS uses AI-assisted engineering sprints to ship customer-economics features safely and quickly.

**Canonical sprint lifecycle:** [OPS_01.md](../../agent/OPS_01.md) (Ops-01 Lite). Use founder commands and gates defined there. This runbook keeps branch prep, validation, recovery playbooks, and architecture hard rules.
...
Related docs:
- [OPS_01.md](../../agent/OPS_01.md) — canonical Ops-01 Lite operating system (plan/execute/merge gates)
- [SPRINT_RECORD.md](../../agent/SPRINT_RECORD.md) — per-sprint record template
...
- [PR_WORKFLOW.md](../../agent/PR_WORKFLOW.md) — PR creation, merge, and recovery via `gh`
...
Follow [OPS_01.md](../../agent/OPS_01.md). Condensed:
...
2. Use `Plan Sprint X using Ops-01.` / `Approve the plan and execute it.` per [OPS_01.md](../../agent/OPS_01.md).
3. Keep the sprint record under `docs/agent/sprints/<sprint-id>.md` ([SPRINT_RECORD.md](../../agent/SPRINT_RECORD.md)).
...
See [PR_WORKFLOW.md](../../agent/PR_WORKFLOW.md) and [OPS_01.md](../../agent/OPS_01.md).
...
See [PR_WORKFLOW.md](../../agent/PR_WORKFLOW.md) — **Recovery: wrong base PR**.
...
A sprint is **done** when all of the following are true (see [OPS_01.md](../../agent/OPS_01.md)):
