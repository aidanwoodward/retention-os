...
> **Historical audit — superseded for current architecture.** Legacy SQL/API metric catalog; not authoritative for the eight-route spine. Current metrics: [`METRIC_CONTRACTS.md`](../../METRIC_CONTRACTS.md). Current architecture: [`RETENTIONOS_ARCHITECTURE.md`](../../RETENTIONOS_ARCHITECTURE.md).
