    ...
    >
      {selection.status === "pending" || selection.status === "lost_upload" ? (
        ...
        <>
          <div className="space-y-6">
            <div>
              <h2 className="text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-500">
                Staircase tails & cohort quality
              </h2>
              <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <MetricStat
                  label="Avg terminal net revenue LTV"
                ...
                />
                <MetricStat
                  label="Avg terminal contribution LTV"
                ...
                />
                <MetricStat
                  label="Strongest net revenue LTV cohort"
                ...
                />
                <MetricStat
                  label="Weakest net revenue LTV cohort"
            ...
            <div>
              ...
              <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <MetricStat label="First-order cohort months" value={String(vm.summary.totalCohorts)} />
                ...
                <MetricStat
                  ...
                  value={formatPct(vm.summary.repeatPurchaseRate)}
                />
              </div>
            </div>
          </div>
          ...
          <AnalyticalPanel
            title="Cohort LTV ladder table"
            description="Each column is cumulative through that cohort-age offset (calendar month from acquisition month, UTC). Terminal values trace the latest observed staircase month in the active dataset window — use strongest vs weakest rows above when judging acquisition-quality variance alongside net revenue versus contribution ladders."
          >
