...
function RetentionOSLogoSquare() {
  return (
...
function AvatarCircle() {
  return (
    <div className="relative rounded-full shrink-0 size-8 bg-blue-600">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 rounded-full border border-blue-500 pointer-events-none"
      />
    </div>
  );
}
...
function SearchContainer({ isCollapsed = false }: { isCollapsed?: boolean }) {
  ...
  return (
    ...
    >
      <div
        className={`bg-neutral-800 h-10 relative rounded-lg flex items-center transition-all duration-500 ${
      ...
      >
        ...
        >
          <div className="flex flex-col justify-center size-full">
            <div className="flex flex-col gap-2 items-start justify-center pr-2 py-1 w-full">
              <input
                type="text"
                placeholder="Search retention data..."
                value={searchValue}
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 rounded-lg border border-neutral-700 pointer-events-none"
        />
      </div>
    </div>
  );
      ...
      sections: [
        {
          title: "Overview",
          items: [
            { icon: <View size={16} className="text-neutral-50" />, label: "Dashboard", isActive: true },
            {
              icon: <ChartBar size={16} className="text-neutral-50" />,
              label: "Key Metrics",
              hasDropdown: true,
              children: [
                { label: "Retention Rate: 34.2%" },
                { label: "Customer LTV: $4,280" },
                { label: "Churn Rate: 3.1%" },
                { label: "Repeat Purchase: 67%" },
              ],
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              hasDropdown: true,
              children: [
                { label: "⚠️ 15% retention drop" },
                { label: "🎯 50 at-risk customers" },
                { label: "📈 Revenue up 12%" },
      ...
      sections: [
        {
          ...
          items: [
            { icon: <ChartBar size={16} className="text-neutral-50" />, label: "Cohort Matrix", isActive: true },
            {
              icon: <Analytics size={16} className="text-neutral-50" />,
              label: "Retention Trends",
              hasDropdown: true,
              children: [
                { label: "Month 1: 85%" },
                { label: "Month 3: 67%" },
        ...
        },
        {
          title: "Quick Actions",
          items: [
            { icon: <AddLarge size={16} className="text-neutral-50" />, label: "New cohort analysis" },
            { icon: <Filter size={16} className="text-neutral-50" />, label: "Filter cohorts" },
            { icon: <Share size={16} className="text-neutral-50" />, label: "Export data" },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          title: "Segment Types",
          items: [
            { icon: <UserMultiple size={16} className="text-neutral-50" />, label: "All Segments", isActive: true },
            {
              icon: <StarFilled size={16} className="text-neutral-50" />,
              label: "Value Segments",
              hasDropdown: true,
              children: [
                { label: "VIP: 150 customers" },
                { label: "High Value: 1,200" },
                { label: "Medium Value: 3,400" },
            ...
            },
            {
              ...
              hasDropdown: true,
              children: [
                { label: "Frequent: 1,800" },
                { label: "Regular: 2,500" },
                { label: "Occasional: 2,200" },
                { label: "One-time: 1,500" },
              ],
            },
          ],
        },
        {
          title: "Quick Actions",
          items: [
            { icon: <AddLarge size={16} className="text-neutral-50" />, label: "Create segment" },
            { icon: <Filter size={16} className="text-neutral-50" />, label: "Filter segments" },
            { icon: <Share size={16} className="text-neutral-50" />, label: "Export segments" },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          title: "Reports",
          items: [
            { icon: <Report size={16} className="text-neutral-50" />, label: "Retention Report" },
            { icon: <ChartBar size={16} className="text-neutral-50" />, label: "Cohort Analysis" },
            { icon: <Analytics size={16} className="text-neutral-50" />, label: "Customer Journey" },
          ],
        },
        {
          title: "Insights",
      ...
      sections: [
        {
          title: "Connections",
          items: [
            { icon: <Integration size={16} className="text-neutral-50" />, label: "Shopify Connected" },
            { icon: <CloudUpload size={16} className="text-neutral-50" />, label: "Last Sync: 2h ago" },
            { icon: <Security size={16} className="text-neutral-50" />, label: "Data Security" },
          ],
        },
        {
          title: "Quick Actions",
          items: [
            { icon: <CloudUpload size={16} className="text-neutral-50" />, label: "Sync Now" },
            { icon: <SettingsIcon size={16} className="text-neutral-50" />, label: "Sync Settings" },
            { icon: <View size={16} className="text-neutral-50" />, label: "Sync History" },
          ],
        },
      ],
    },
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center rounded-lg size-10 min-w-10 transition-colors duration-500
        ${isActive ? "bg-blue-600 text-white" : "hover:bg-neutral-800 text-neutral-400 hover:text-neutral-300"}`}
      style={{ transitionTimingFunction: softSpringEasing }}
      onClick={onClick}
    >
      {children}
...
function IconNavigation({
  ...
  const navItems = [
    ...
    { id: "cohorts", icon: <ChartBar size={16} />, label: "Cohorts" },
    { id: "segments", icon: <UserMultiple size={16} />, label: "Segments" },
    { id: "analytics", icon: <Analytics size={16} />, label: "Analytics" },
    { id: "sync", icon: <CloudUpload size={16} />, label: "Sync" },
  ];

  return (
    <aside className="bg-neutral-900 flex flex-col gap-2 items-center p-4 w-16 h-[800px] border-r border-neutral-800 rounded-l-2xl">
      {/* Logo */}
...
function DetailSidebar({ activeSection }: { activeSection: string }) {
  ...
  return (
    <aside
      className={`bg-neutral-900 flex flex-col gap-4 items-start p-4 rounded-r-2xl transition-all duration-500 h-[800px] ${
      ...
      {!isCollapsed && (
        <div className="w-full mt-auto pt-2 border-t border-neutral-800">
          <div className="flex items-center gap-2 px-2 py-2">
            <AvatarCircle />
            <div className="font-['Lexend:Regular',_sans-serif] text-[14px] text-neutral-50">RetentionOS User</div>
            <button
              type="button"
    ...
    >
      <div
        className={`rounded-lg cursor-pointer transition-all duration-500 flex items-center relative ${
          item.isActive ? "bg-blue-600" : "hover:bg-neutral-800"
...
export function RetentionOSSidebar() {
  return (
...
export default RetentionOSSidebar;
