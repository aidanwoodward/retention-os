...
function IconNavigation({
  ...
  return (
    <aside className="bg-neutral-900 flex flex-col gap-2 items-center p-4 w-16 h-screen border-r border-neutral-800 rounded-l-2xl">
      {/* Logo */}
...
function DetailSidebar({ activeSection }: { activeSection: string }) {
  ...
  return (
    <aside
      className={`bg-neutral-900 flex flex-col gap-4 items-start p-4 rounded-r-2xl transition-all duration-500 h-screen ${
