...
> **Historical pre-restart status.** This document is preserved as a record of the broad mock-navigation MVP and is not current product or architecture truth. Use [`RETENTIONOS_ARCHITECTURE.md`](../../RETENTIONOS_ARCHITECTURE.md) for the retained eight-route command centre and evidence-backed route/API dispositions.
