...
> **Historical — superseded for current onboarding authority.** Current contracts: [`IMPORT_TRUST.md`](../../IMPORT_TRUST.md), [`DATASET_LIFECYCLE.md`](../../DATASET_LIFECYCLE.md), [`RETENTIONOS_SHOPIFY_CSV_CONTRACT.md`](../../RETENTIONOS_SHOPIFY_CSV_CONTRACT.md). Body preserved as pre-restart evidence.
